...
// Função para mesclar dois subvetores de forma decrescente
void merge(int *vetor, int inicio, int meio, int fim) {
    ...
    // Mescla os vetores temporários de volta no vetor original em ordem decrescente
...
int main(int argc, char *argv[]) {
    ...
    printf("Vetor ordenado de forma decrescente e salvo com sucesso no arquivo %s\n", nomeArquivoSaida);
